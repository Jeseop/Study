...
exports.default = exports.config = exports.GITMOJIS_URL = void 0;
...
const setGitmojisUrl = gitmojisUrl => {
  config.set(_prompts.CONFIGURATION_PROMPT_NAMES.GITMOJIS_URL, gitmojisUrl);
};
...
const getGitmojisUrl = () => {
  return config.get(_prompts.CONFIGURATION_PROMPT_NAMES.GITMOJIS_URL) || GITMOJIS_URL;
};
